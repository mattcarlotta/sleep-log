...
export default function Modal({ children, onCancel, title }: ModalProps) {
    return createPortal(
        <div className="fixed top-0 right-0 bottom-0 left-0 z-1200">
            <div className="fixed top-0 right-0 bottom-0 left-0 z-[-1] flex items-center justify-center bg-black/70 backdrop-blur-sm" />
            <div className="h-full flex justify-center items-center">
                <dialog
                    ...
                    aria-modal="true"
                >
                    <div className="flex flex-row items-center border-b border-gray-300 bg-linear-to-r/decreasing from-indigo-500 to-teal-400 text-slate-100 dark:bg-linear-to-r dark:from-gray-700 dark:via-purple-800 dark:to-gray-700 dark:border-gray-700">
