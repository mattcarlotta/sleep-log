        ...
        <div className="fixed top-0 right-0 bottom-0 left-0 z-1200">
            ...
            <div className="h-full flex justify-center items-center">
                <dialog
                    ...
                    aria-modal="true"
                >
                    <div className="flex flex-row items-center border-b border-gray-300 bg-linear-to-r/decreasing from-indigo-500 to-teal-400 text-slate-100 dark:bg-gradient-to-r dark:from-gray-700 dark:via-purple-800 dark:to-gray-700 dark:border-gray-700">
                        ...
                        <div className="flex justify-end rounded-full w-14 mr-1">
                            <button
                                ...
                                onClick={onCancel}
                            >
                                <CancelIcon className="h-6 w-6 fill-white" />
                            </button>
                        </div>
                    </div>
                    <div className="flex-1 space-y-4 overflow-y-auto p-5 relative overflow-x-hidden bg-white sm:h-auto">
                        {children}
                    </div>
                    <div className="flex flex-initial border-t border-b border-gray-300 bg-linear-to-r/decreasing from-indigo-500 to-teal-400 p-4 dark:bg-gradient-to-r dark:from-gray-700 dark:via-purple-800 dark:to-gray-700 dark:border-gray-700" />
                </dialog>
            </div>
        </div>,
        document.body
