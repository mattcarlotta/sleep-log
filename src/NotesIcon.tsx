export default function NotesIcon({ className }: { className?: string }) {
    return (
        <svg className={className} viewBox="2 0 24 24" fill="none" version="1.1" xmlns="http://www.w3.org/2000/svg">
            ...
            />
            <path d="M8 8H16" stroke="#000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M8 12H12" stroke="#000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    );
}
